...
- ⚠️ **Editar `_shared/` sem rodar `scripts/sync-shared.sh`** deixa as 14 cópias vendoradas defasadas — fix de código compartilhado nasce em `_shared/`, nunca na cópia.
