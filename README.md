...
| Comando | O que faz |
|---|---|
| `/plan` | Vira a spec aprovada em plano ticável. **Antes de criar qualquer plano novo, imprime os que ainda estão abertos** no projeto — a palavra "plano" sozinha já é a invocação, justamente para isso aparecer. A palavra "plano" sozinha, sem mais contexto, já é a invocação. |
