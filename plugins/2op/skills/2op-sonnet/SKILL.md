...
cabeça ou a mesma. `/2op-sonnet` só entrega segunda opinião de verdade quando a sessão não
está rodando Sonnet. O modelo titular (que fez o trabalho acima) volta no próximo prompt e
