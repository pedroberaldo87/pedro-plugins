<!-- VENDORADO de github.com/google-labs-code/design.md @ docs/spec.md (CLI v0.3.0, formato "alpha"). -->
<!-- Por que vendorado e não puxado pelo CLI: `design.md spec` está QUEBRADO no pacote npm publicado -->
<!-- (v0.3.0 não copia docs/spec.md pro dist/ → "Failed to load spec.md"). Re-sincronizar quando o upstream -->
<!-- consertar o `spec` OU bumpar a versão: baixar docs/spec.md do repo e atualizar a versão acima. -->
