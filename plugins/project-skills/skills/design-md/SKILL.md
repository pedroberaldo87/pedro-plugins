...
## Quando isto é a etapa de interface do `/start`

O `/start` conduz a concepção em cinco etapas de acordo — autoral, arquitetura, **interface**,
...
Duas obrigações a mais quando o chamador é o `/start`:
