...
```bash
python3 plugins/project-doc/lib/pattern_check.py --project-root "<root>" --census
```
...
```bash
python3 plugins/project-doc/lib/pattern_check.py --project-root "<root>" --plan
```
...
```bash
python3 plugins/project-doc/lib/doc_lint.py --project-root "<root>" --json
```
