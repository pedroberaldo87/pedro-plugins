...
`/project-doc`, mandando as duas trocas concretas (comando no lugar do
...
def main():
    ...
    check("a secao de desacoplamento existe no /project-doc", SECAO in full)
    ...
    check("o touch aponta a secao canonica do /project-doc pelo titulo",
          SECAO in touch)
