...
KIND_LABEL = {"user_directive": "Direcionamento do usuário", "tool_rejection": "Direcionamento (rejeição/feedback)",
...
def build_prospective(records, items):
    ...
    falso-positivo (caso real: 7 "abertas" no join ingênuo vs 0 reais). O collect() acima
